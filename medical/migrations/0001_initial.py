        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                               to='medical.testcategory', verbose_name='категория')),
            ],
            options={
                'verbose_name': 'Анализ',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visit', models.CharField(
                    choices=[('первичный прием', 'первичный прием'), ('повторный прием', 'повторный прием')],
                    max_length=20)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                               to='medical.testcategory', verbose_name='категория')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timeslot', models.IntegerField(
                    choices=[(0, '09:00 – 09:30'), (1, '10:00 – 10:30'), (2, '11:00 – 11:30'), (3, '12:00 – 12:30'),
                             (4, '13:00 – 13:30'), (5, '14:00 – 14:30'), (6, '15:00 – 15:30'), (7, '16:00 – 16:30'),
                             (8, '17:00 – 17:30')], verbose_name='время приема')),
